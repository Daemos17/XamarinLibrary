...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GoogleVisionBarCodeScanner.Renderer.TaskCompleteListener, BarcodeScanner.XF", TaskCompleteListener.class, __md_methods);
	}
	...
	public TaskCompleteListener ()
	{
		...
		if (getClass () == TaskCompleteListener.class)
			mono.android.TypeManager.Activate ("GoogleVisionBarCodeScanner.Renderer.TaskCompleteListener, BarcodeScanner.XF", "", this, new java.lang.Object[] {  });
	}
